...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'air-tight-orchestra':
				dialogue = CoolUtil.coolTextFile(Paths.txt('air-tight-orchestra/airDialogue'));
			case 'cold-melody':
				dialogue = CoolUtil.coolTextFile(Paths.txt('cold-melody/coldDialogue'));
			case 'plant-symphony':
				dialogue = CoolUtil.coolTextFile(Paths.txt('plant-symphony/plantDialogue'));
		}
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'thorns':
			{
				...
				case 'plant-symphony':
				{
						curStage = 'plantIsland';
					
						defaultCamZoom = 0.8;
	
						var bg:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/plantBG'));
						...
						var stageFront:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/plantIsland'));
						...
						bottomBoppers = new FlxSprite(-400, 150);
						bottomBoppers.frames = Paths.getSparrowAtlas('islands/plantSpecLeft');
						bottomBoppers.animation.addByPrefix('bop', 'plantBoppersLeft', 24, false);
						bottomBoppers.antialiasing = true;
							bottomBoppers.scrollFactor.set(0.9, 0.9);
							bottomBoppers.setGraphicSize(Std.int(bottomBoppers.width * 1));
						bottomBoppers.updateHitbox();
						...
						upperBoppers = new FlxSprite(0, 150);
						upperBoppers.frames = Paths.getSparrowAtlas('islands/plantSpecRight');
						upperBoppers.animation.addByPrefix('bop', "plantBoppersRight", 24, false);
						upperBoppers.antialiasing = true;
				...
				case 'cold-melody':
				{
						...
						var bg:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/coldBG'));
						bg.setGraphicSize(Std.int(bg.width * 1.1));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						...
						var stageFront:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/coldIsland'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
						...
						bottomBoppers = new FlxSprite(-350, 50);
						bottomBoppers.frames = Paths.getSparrowAtlas('islands/coldSpecLeft');
						bottomBoppers.animation.addByPrefix('bop', 'coldBoppersLeft', 24, false);
						bottomBoppers.antialiasing = true;
							bottomBoppers.scrollFactor.set(0.9, 0.9);
							bottomBoppers.setGraphicSize(Std.int(bottomBoppers.width * 1));
						bottomBoppers.updateHitbox();
						...
						upperBoppers = new FlxSprite(-250, 100);
						upperBoppers.frames = Paths.getSparrowAtlas('islands/coldSpecRight');
						upperBoppers.animation.addByPrefix('bop', "coldBoppersRight", 24, false);
						upperBoppers.antialiasing = true;
						upperBoppers.scrollFactor.set(0.9, 0.9);
						upperBoppers.setGraphicSize(Std.int(upperBoppers.width * 1));
						upperBoppers.updateHitbox();
				...
				case 'air-tight-orchestra':
				{
						...
						var bg:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/airBG'));
						bg.setGraphicSize(Std.int(bg.width * 1.1));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						...
						var stageFront:FlxSprite = new FlxSprite(-625, -315).loadGraphic(Paths.image('islands/airIsland'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
						...
						bottomBoppers = new FlxSprite(-350, 50);
						bottomBoppers.frames = Paths.getSparrowAtlas('islands/airSpecLeft');
						bottomBoppers.animation.addByPrefix('bop', 'airBoppersLeft', 24, false);
						bottomBoppers.antialiasing = true;
							bottomBoppers.scrollFactor.set(0.9, 0.9);
							bottomBoppers.setGraphicSize(Std.int(bottomBoppers.width * 1));
						bottomBoppers.updateHitbox();
						...
						upperBoppers = new FlxSprite(-250, 50);
						upperBoppers.frames = Paths.getSparrowAtlas('islands/airSpecRight');
						upperBoppers.animation.addByPrefix('bop', "airBoppersRight", 24, false);
						upperBoppers.antialiasing = true;
						upperBoppers.scrollFactor.set(0.9, 0.9);
						upperBoppers.setGraphicSize(Std.int(upperBoppers.width * 1));
						upperBoppers.updateHitbox();
				...
				if (storyPlaylist.length <= 0)
					{
						...
						if (curSong == "Plant-Symphony"){
							FlxG.switchState(new EndingState(accuracy >= 70));
							
							
						if (accuracy >= 70){
							
							FlxG.sound.playMusic(Paths.music("Win"),1,false);
						}else{
							FlxG.sound.playMusic(Paths.music("Win"),1,false);
						}
