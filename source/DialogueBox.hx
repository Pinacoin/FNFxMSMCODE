	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'air-tight-orchestra':
				FlxG.sound.playMusic(Paths.music('Dee'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'cold-melody':
				FlxG.sound.playMusic(Paths.music('Boom'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'plant-symphony':
				FlxG.sound.playMusic(Paths.music('Baa'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
		...
		if (PlayState.SONG.song.toLowerCase()=='air-tight-orchestra' || PlayState.SONG.song.toLowerCase()=='cold-melody' || PlayState.SONG.song.toLowerCase()=='plant-symphony')
			{
			portraitLeft = new FlxSprite(-100, 0);
			portraitLeft.frames = Paths.getSparrowAtlas('islands/pompomPort');
			portraitLeft.animation.addByPrefix('enter', 'pompomTalk', 24, false);
			...
			portraitA.frames = Paths.getSparrowAtlas('islands/mammottPort');
			portraitA.animation.addByPrefix('enter', 'mammottTalk', 24, false);
			...
			portraitB.frames = Paths.getSparrowAtlas('islands/furcornPort');
			portraitB.animation.addByPrefix('enter', 'furcornTalk', 24, false);
			...
			portraitRight.frames = Paths.getSparrowAtlas('islands/boyfriendPort');
		...
		switch (curCharacter)
		{
			...
			case 'mammott':
				...
				if (!portraitA.visible)
				{
					...
					portraitA.animation.play('enter');
				}
			case 'furcorn':
				portraitLeft.visible = false;
				portraitRight.visible = false;
